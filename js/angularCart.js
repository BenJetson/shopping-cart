...
//            $scope.products.push(new Product($scope.productsAsJSON[i]['itemID'], 
//                                             $scope.productsAsJSON[i]['itemname'], 
//                                             $scope.productsAsJSON[i]['price']));
//        }
//        
//        $scope.loadCart();
//        
...
//            return "-" + ("0000" + Math.abs(number)).slice(-4);
//        } else {
//            return number;
//        }
//    }
...
//        $scope.lcart_str = localStorage[$scope.cart_name];
//        
//        
//        if ($scope.lcart_str!=null && $scope.lcart_str.length!=0)
//        {
//            $scope.item_ids = $scope.lcart_str.split("|");
//            
//            
...
//            
//			$scope.index = $scope.search($scope.id);
//            
//			if ($scope.index>-1 && !isNaN($scope.quantity) && $scope.quantity>=0)
//			{
//				$scope.products[$scope.index].setQuantity($scope.quantity);
//			}
//		}
//        
//		$scope.writeCart();
...
//                $scope.products[$scope.index].bumpQuantity();
//                $scope.writeCart();
//            }
//            
//        }
...
//            for (i=0; i<$scope.products.length; i++)
//            {
//                $scope.id = $scope.products[i].getId();
//                $scope.name = $scope.products[i].getName();
//                $scope.quantity = $scope.products[i].getQuantity();
//                $scope.price = $scope.products[i].getPrice();
...
//            $scope.html_cart_str += "</tr>";
//
//            if (!$scope.free_shipping)
//            {
//                $scope.html_cart_str += "<tr class='shipping'>";
//                $scope.html_cart_str += "<th class='shipping' colspan='3'>Shipping:</th>";
//                $scope.html_cart_str += "<td class='shipping'>$" + $scope.shipping_rate.toFixed(2) + "</td>";
//                $scope.html_cart_str += "</tr>";
//
//                $scope.total += $scope.shipping_rate;
//            }
//
...
//            $scope.html_cart_str += "<input type='button' value='Update' onclick='updateCart();' />";
...
//            
////            $log.debug($scope.products[i].getName() + " |!| " + $scope.q.toString());
//            
...
//        
////        $log.debug(" ---- Cart2Str Complete. ---- ");
////        for (var i=0; i<5; i++) { $log.debug("  ".repeat(i)); }
//        
